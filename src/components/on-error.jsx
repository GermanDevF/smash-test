...
const Error = () => {
  return (
    <div class="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-slate-400">
      <div class="text-center">
        ...
        <p class="text-slate-200 mt-5 lg:text-lg">Oops something went wrong. Try to refresh this page or <br /> feel free to contact us if the problem presists.</p>
        <Link href="/" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full mt-3">Go home</Link>
      </div>
    </div>
  )
}
